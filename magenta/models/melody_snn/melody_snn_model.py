...
class MelodySnnModel(events_rnn_model.EventSequenceRnnModel):
  """Class for SNN melody generation models."""
...
class MelodySnnConfig(events_rnn_model.EventSequenceRnnConfig):
  """Stores a configuration for a MelodySnn.
  ...
  def __init__(self, details, encoder_decoder, hparams,
    ...
    super(MelodySnnConfig, self).__init__(details, encoder_decoder, hparams)
