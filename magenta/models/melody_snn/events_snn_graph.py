...
"""Provides function to build an event sequence SNN model's graph."""
import numbers
...
def get_build_graph_fn(mode, config, sequence_example_file_paths=None):
  ...
  Args:
    mode: 'train', 'eval', or 'generate'. Only mode related ops are added to
        the graph.
    config: An EventSequenceSnnConfig containing the encoder/decoder and HParams
        to use.
