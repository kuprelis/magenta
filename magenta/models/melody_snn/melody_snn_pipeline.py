...
"""Pipeline to create MelodySNN dataset."""
...
class EncoderPipeline(pipeline.Pipeline):
  ...
  def __init__(self, config, name):
    ...
    Args:
      config: A MelodySnnConfig that specifies the encoder/decoder, pitch range,
...
def get_pipeline(config, transposition_range=(0,), eval_ratio=0.0):
  """Returns the Pipeline instance which creates the SNN dataset.

  Args:
    config: A MelodySnnConfig object.
