...
TensorFlow's SequenceExample protos for input to the melody SNN models.
"""

import os

from magenta.models.melody_snn import melody_snn_config_flags
from magenta.models.melody_snn import melody_snn_pipeline
...
def main(unused_argv):
  ...
  config = melody_snn_config_flags.config_from_flags()
  pipeline_instance = melody_snn_pipeline.get_pipeline(
